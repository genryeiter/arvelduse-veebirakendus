...
import Empty from '../../icons/svgIcons/Empty'
...
const Dashboard = () => {
    ...
    return (<div className={styles.pageContainer}>
        ...
        {paymentHistory.length !== 0 && (<section>
            <h1 style={{
                textAlign: 'center', paddingBottom: '30px',
            }}>{paymentHistory.length ? 'Billing Charts' : 'No payment received yet'}</h1>
            <Chart paymentHistory={paymentHistory}/>
        </section>)}
        <section>
            <h1 style={{
                textAlign: 'center', padding: '30px',
            }}>{paymentHistory.length ? 'Recent Payments' : 'No payment received yet'}</h1>
            <div>
                <div className={styles.table}>

                    <table>
                        <tbody>
                        {paymentHistory.length !== 0 && (<tr>
